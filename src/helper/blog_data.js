    ...
    // post 2
    {
      ...
      "items": [
        ...
        },
        {
          "type": "paragraph",
          "paragraph_title": "",
          "text": "Your web composition and advancement fundamentally characterizes your internet based presence. Indeed, even the most essential enhancements in your site can have broad impacts on your progress in the commercial center",
          "class_name": "",
          "m_class_name": ""
        },
        {
          "type": "paragraph",
          "paragraph_title": "<br>5 keys to master in website architecture:",
          "text": "<br><b>1. Visual Appeal</b> <br><br> You just have a single opportunity to establish an incredible first connection. Are your site guests saying WOW! or on the other hand OW!? when they see your site interestingly? Individuals arrive at prompt conclusions about the validity of your organization, image and items when they see your site." +
            "<br><br><b>2. Convenience</b> <br><br>" +
            "In the event that your site won't be quickly explored and your significant substance won't be quickly found, then, at that point, your clients will go somewhere else. Try not to let this be the situation. At Thrive, we make a solid effort to plan and fabricate natural, basic and simple to explore sites. We maintain that our clients should feel like everything is correct where they anticipate that it should be." +
            "<br><br><b>3. Top caliber, Optimized Content</b> <br><br>" +
            "Putting resources into lovely web composition and dismissing the substance resembles purchasing a vehicle without a motor. A predominant site has convincing and succinct substance with clear CTAs. At the point when you work with us, our web composition specialists work intimately with you to guarantee your website content is elegantly composed, web search tool streamlined and made considering clear business targets." +
            "<br><br><b>4. Change of Visitors into Customers</b> <br><br>" +
            "From the beginning in the arranging system, we figure out what a \"change\" or CTA looks like for your site. It very well may be to present a lead structure, settle on a telephone decision or buy an item. We then, at that point, remember that objective for the whole interaction, from plan and coding to content composition. We maintain that your site should be the essential apparatus for development in your organization." +
            "<br><br><b>5. Traffic Growth Over Time</b> <br><br>" +
            "At Thrive, we need to see your new site ascend to a higher level. That's what to do, we want bunches of value traffic.\n" +
            "<br><br>Whether you require an imaginative site to create prospective customers, a web based business online store to sell your items or essentially burnt out on your old site, we are generally accessible to help and develop your business." +
            "<br><br> <span class='font-italic fw-450'> Thanks for reading !!</span>",
          "class_name": "",
          "m_class_name": ""
        }
